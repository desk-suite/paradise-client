...
export const Header = () => {
  ...
  const settingsMenu = (
    <Menu>
      ...
      <Menu.Divider />
      <Menu.Item onClick={() => {ipcRenderer.send('checkUpdates');}}>Buscar actualizaciones</Menu.Item>
      ...
      <Base>
        ...
        <Info>
          <Dropdown overlay={settingsMenu} trigger={['click']} placement="bottomRight">
            <Icon component={MdSettings} style={
              { 
                padding: '4px',
                cursor: 'pointer',
                fontSize: '24px'
          ...
          <Dropdown overlay={userMenu} trigger={['click']} placement="bottomRight">
            <Icon component={MdChatBubbleOutline} style={
              { 
                padding: '4px',
                cursor: 'pointer',
                fontSize: '24px'
